...
i   2. Add a URL to urlpatterns:  path('', Home.as_view(), name='home')
Including another URLconf
    1. Import the include() function: from django.urls import include, path
    2. Add a URL to urlspatterns:  path('blog/', include('blog.urls'))
"""
...
urlpatterns = [
    ...
    path("crud/edit/<int:pk>", views.ProductUpdateViews.as_view(), name="edit"),
